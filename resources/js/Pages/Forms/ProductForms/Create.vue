...
const submit = () => {
    form.post(route('product.store')), {onSuccess: () => { emit('closeCreate') }}
}
...
<form v-on:submit.prevent="submit" class="w-full h-[80vh]" >
    ...
    <div class="flex justify-center items-center mb-5">
        ...
        <div class="w-1/6 flex justify-end">
            <button @click="emit('closeCreate')" class="text-gray-600 dark:text-white bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-700 dark:bg-gray-600">
    ...
    <div class="grid xl:grid-cols-3 sm:grid-cols-1 ">
        <!-- DropZone -->
        <div class="mr-5">
            <DropZone @imageFile="receiveImageFile" @change="handleFileChange" :class="{'border border-red-500 dark:border-red-500' : page.props.errors.image_01}" @focus="page.props.errors.image_01 = ''"/>
            <InputFull
                v-model:model="form.image_01.name"
